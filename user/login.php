...
if(isset($_POST['submit']))  
{
	...
	if(!empty($_POST["submit"]))   
     {
	$loginquery ="SELECT * FROM cus_details WHERE username='$username'"; //selecting matching records
...
<div class="module form-module">
  ...
  <div class="form">
   ...
   <span style="color:green;"><?php echo $success; ?></span>
    ...
    <div class="cta"><a href="reset.php" style="color:#5c4ac7;"> Password reset</a></div>
  </div>
