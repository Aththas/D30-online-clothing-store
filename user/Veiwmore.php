        ...
        <div class="page-wrapper">
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="view.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite food</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from tbl_product where product_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/headBackgroun.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
						...
						<?php  
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" ><?php echo $product['product_price']; ?></span>
